  ...
  return (
     <Container maxWidth="sm" style={{ marginTop: '20px' }}>
      <form onSubmit={addFormElement}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) => setInputForm({ ...inputForm, discount: e.target.value })}
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) => setInputForm({ ...inputForm, rating: e.target.value })}
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) => setInputForm({ ...inputForm, stock: e.target.value })}
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) => setInputForm({ ...inputForm, brand: e.target.value })}
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
        ...
        <OperationButton type="submit" text="Add element" />
      </form>
    </Container>
  );
}
